...
penalize_reproj = None

penalize_encoder_diagram_mstep_schedule = [False, True, True]
penalize_encoder_diagram_mstep = None
...
# DATA
dataset = 'init0p1_lqr.pkl' #'custom-drift_match-500k.pkl' #'gym-1step-5million.pkl'
dataset2 = 'custom-drift_match-500k.pkl'
num_traj = int(8e3)
traj_len = 750
num_test_traj = int(2e3)
init_pert = 0.1

dataset_finetune = 'lqr-dataset.pkl'
num_traj_finetune = int(1e4)
traj_len_finetune = 15
